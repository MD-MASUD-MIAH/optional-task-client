    ...
    <div className="min-h-scree py-10 ">
      ...
      <div className="p-6 flex flex-col items-center">
        ...
        <div className="self-start mb-4">
          <Link to='/adduser' className="btn btn-sm btn-outline btn-primary shadow-md">
            ...
            users.map((user,index)=>   <tr key={user._id} user={user}>
                ...
                <td>
                  <div className="flex gap-2">
                    <Link to={`/update/${user._id}`} className="btn btn-xs btn-ghost text-purple-600">
                      <FaEdit />
                    </Link>
                    <button onClick={()=>handleDelte(user._id)} className="btn btn-xs btn-ghost text-purple-600">
                      <FaTimes />
                    </button>
                  </div>
                </td>
